...

{
	...
	function excel($task = 'excel', $alt = 'Excel') {
		$bar = & JToolBar::getInstance ( 'toolbar' );
		$bar->appendButton ( 'link', 'excel', $alt, 'index.php?option=com_rubriestav&controller=user&format=xls' );
	}
	function games($task = 'games', $alt = 'Games') {
		$bar = & JToolBar::getInstance ( 'toolbar' );
		$bar->appendButton ( 'link', 'games', $alt, 'index.php?option=com_rubriestav&controller=games' );
	}
}
